...
const editArmorType = (document.getElementById('equipped-armor-type'));
...
export function fillAttacksEditHTML() {
    ...
    for (let attack of characterSheet.attacks) {
        ...
        let proficientContainer = document.createElement('label');
        ...
        let proficientCheckmark = document.createElement('span');
        ...
        let finesseContainer = document.createElement('label');
        ...
        let finesseCheckmark = document.createElement('span');
        ...
        let rangedContainer = document.createElement('label');
        ...
        let rangedCheckmark = document.createElement('span');
